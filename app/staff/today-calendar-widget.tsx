  ...
  return (
    <section className="bg-white border border-nu-ink/[0.06]">
      <div className="p-4 border-b border-nu-ink/5 flex items-center justify-between">
        ...
        <Link href="/staff/calendar" className="font-mono-nu text-[11px] text-indigo-600 no-underline hover:underline uppercase tracking-widest">
          전체
        </Link>
      </div>
      {loading ? (
        ...
        <div className="divide-y divide-nu-ink/5">
          {events.slice(0, 5).map(ev => (
            ...
            >
              ...
              <p className="font-mono-nu text-[10px] text-nu-muted flex items-center gap-1 mt-0.5">
                <Clock size={9} />
        ...
        <div className="p-5 text-center">
          <p className="font-mono-nu text-[12px] text-nu-muted">오늘 일정이 없습니다</p>
        </div>
      )}
    </section>
  );
