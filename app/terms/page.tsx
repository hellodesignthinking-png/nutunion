      ...
      <div className="max-w-4xl mx-auto px-8 py-16">
        <div className="prose prose-nu max-w-none space-y-12 text-nu-ink/80 leading-relaxed">
          ...
          <Section num="2" title="용어의 정의">
            <Ul items={[
              '"서비스"란 회사가 nutunion.co.kr을 통해 제공하는 소모임 운영, 프로젝트 관리, 인재 탐색, 의뢰 관리 등 모든 온라인 서비스를 의미합니다.',
              '"회원"이란 회사와 이용계약을 체결하고 회원 아이디를 부여받은 자를 의미합니다.',
              '"소모임"이란 회원들이 공통 관심사를 기반으로 구성한 그룹 활동 단위를 의미합니다.',
              '"프로젝트"란 소모임 또는 개인이 수행하는 목표 지향적 활동 단위를 의미합니다.',
          ...
          <Section num="5" title="회원의 의무">
            ...
            <Ul items={[
              ...
              "소모임·프로젝트 활동에서 타 회원에게 부당한 불이익을 주는 행위",
            ]} />
          </Section>
