/**
 * Shared template content used by both group and project seeders.
 * When a template resource is created, its content is stored in the DB
 * so users can edit it inline.
 */

export const TEMPLATE_CONTENT: Record<string, string> = {
  "sprint-guide": `# Sprint 운영 가이드
...
- `,
  ...
  "paper-selection-guide": `# 논문 선정 가이드
